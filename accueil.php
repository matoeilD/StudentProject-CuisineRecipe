<?php
	...
	$sql = "SELECT r.id, label_recette, description_recette, r.date, image, AVG(note) noteAVG FROM recette r left join commentaire on r.id=idR GROUP BY r.id ORDER BY r.date DESC LIMIT 0,4";
