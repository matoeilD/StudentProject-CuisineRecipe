<?php
	...
	$sql = "SELECT id, label_recette, description_recette, horodateAjout_recette FROM recette order by horodateAjout_recette";
			...
			<div class="container">
				...
				<nav id="nav">
					<ul>
						...
						<li  class="active"><a href="recettes.php">Les Recéttes</a></li>
